    ...
    <v-app :style="{ background: $vuetify.theme.themes.dark.background }">
        ...
        <v-container>
            <v-toolbar color="rgba(0,0,0,0)" flat>
                ...
                <v-spacer></v-spacer>
                <v-text-field label="Search category or menu..." class="mt-5" color="brown" filled append-icon="mdi-magnify"
                        ...
                        <v-col cols="12" md="2">
                            <v-item v-slot="{ active, toggle }">
                                <v-card :color="active ? '#F6EFEF' : 'white'" :class="active ? 'borderme' : 'borderout'"
                                    class="d-flex align-center rounded-lg mx-2" dark height="140" @click="toggle" flat>
                                    <v-row>
                                        <v-col cols="12" sm="12">
                                            <v-list-item three-line class="text-center ">
                                                <v-list-item-content>
                                                    <div align="center" justify="center">
                                                        ...
                                                        <v-img src="c1.png" max-height="110" max-width="110"
                                                            contain></v-img>
                                            ...
                                            <v-list-item three-line class="text-center ">
                                                <v-list-item-content>
                                                    <div align="center" justify="center">
                                                        ...
                                                        <v-img src="c5.png" max-height="110" max-width="110"
                                                            contain></v-img>
                                            ...
                                            <v-list-item three-line class="text-center ">
                                                <v-list-item-content>
                                                    <div align="center" justify="center">
                                                        ...
                                                        <v-img src="c6.png" max-height="110" max-width="110"
                                                            contain></v-img>
            ...
            <v-toolbar color="#EEEEEE" flat>
                <v-toolbar-title>Coffee Menu</v-toolbar-title><v-spacer></v-spacer><span color="grey">12 Coffees
                    Results</span>
            </v-toolbar>
            <v-row>
                <v-col cols="12" sm="6">
                    <v-card flat class="rounded-lg mx-5">
                        <v-list-item three-line>
                            ...
                            <v-list-item-content>
                                ...
                                <v-list-item-subtitle class="mt-1">Caramel sytrup with coffee, milk, and whipped
                                    cream</v-list-item-subtitle>
                                <strong class="mt-3">
                                    $3.95
                                </strong>
                                                ...
                                                <v-col cols="12" md="4">
                                                    <v-item v-slot="{ active, toggle }">
                                                        <v-card color="#F6EFEF" :class="active ? 'borderme' : ''"
                                                            class="d-flex align-center rounded-circle " dark height="50"
                                                            width="50" @click="toggle" flat>
                                        ...
                                        <v-container>
                                            <v-row class="">
                                                <v-col cols="12" md="4">
                                                    <v-item v-slot="{ active, toggle }">
                                                        <v-card color="#F6EFEF" :class="active ? 'borderme' : ''"
                                                            class="d-flex align-center rounded-circle " height="50"
                                                            width="50" @click="toggle" flat>
                                                            <v-list-item class="text-center">
                                                                <v-list-item-content>
                                                            ...
                                                            <v-list-item class="text-center">
                                                                <v-list-item-content>
                                                                    <strong class="overline"
                                                                        :class="active ? 'brown--text' : 'red--text'">30%</strong>
                                                                </v-list-item-content>
                                                            </v-list-item>
                                                        </v-card>
                                                    </v-item>
                                                    ...
                                                    <v-item v-slot="{ active, toggle }">
                                                        <v-card color="#F6EFEF" :class="active ? 'borderme' : ''"
                                                            ...
                                                            <v-list-item class="text-center">
                                                                <v-list-item-content>
                                                                    <strong class="overline"
                                                                        :class="active ? 'brown--text' : 'red--text'">50%</strong>
                                                                </v-list-item-content>
                                                            </v-list-item>
                                                        </v-card>
                                                    </v-item>
                                                    ...
                                                    <v-item v-slot="{ active, toggle }">
                                                        <v-card color="#F6EFEF" :class="active ? 'borderme' : ''"
                                                            ...
                                                            <v-list-item class="text-center">
                                                                <v-list-item-content>
                                                                    <strong class="overline"
                                                                        :class="active ? 'brown--text' : 'red--text'">70%</strong>
                                                                </v-list-item-content>
                                                            </v-list-item>
                                                        </v-card>
                                                    </v-item>
                    ...
                    <v-card flat class="rounded-lg mx-5">
                        <v-list-item three-line>
                            ...
                            <v-list-item-content>
                                ...
                                <v-list-item-subtitle class="mt-1">Sweet chocolate with coffee, milk, and whipped
                                    cream</v-list-item-subtitle>
                                <strong class="mt-3">
                                    $4.51
                                </strong>
